...
export default function AdminOrdersPage() {
  ...
  const filteredOrders = filterStatus === "Todos" ? orders : orders.filter((o) => o.estado === filterStatus)
                ...
                <div>
                  ...
                  <div className="bg-muted rounded-lg p-3 space-y-1">
                    <p className="text-foreground">
                      <strong>Nombre:</strong> {selectedOrder.cliente.nombre}
                    </p>
                    <p className="text-foreground">
                      <strong>Teléfono:</strong> {selectedOrder.cliente.telefono}
                    </p>
                    <p className="text-foreground">
                      <strong>Correo:</strong> {selectedOrder.cliente.correo}
                    </p>
                    <p className="text-foreground">
                      <strong>Dirección:</strong> {selectedOrder.cliente.direccion}
                    </p>
                  </div>
                </div>
